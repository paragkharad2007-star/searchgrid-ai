...
function requestUrgentNotifications(onDone: (message: string) => void) {
  ...
  Notification.requestPermission().then((permission) => onDone(permission === "granted" ? "Urgent sighting alerts enabled" : "Notification permission was not granted"));
}
