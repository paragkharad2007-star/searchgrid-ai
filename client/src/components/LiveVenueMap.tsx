...
export default function LiveVenueMap({ zones, selectedId, onSelect, volunteerLocations = {} }: { zones: MapZone[]; selectedId: string; onSelect: (zone: MapZone) => void; volunteerLocations?: Record<string, { lat: number; lng: number; accuracy: number }> }) {
